...
void CQuadEX1::SetShader(mat4 &mxModelView, mat4 &mxProjection, GLuint uiShaderHandle)
{
	...
	if( uiShaderHandle == MAX_UNSIGNED_INT) m_uiProgram = InitShader("vsVtxColorEX1.glsl", "fsVtxColor.glsl");
	...
	m_uiAngleLoc = glGetUniformLocation(m_uiProgram, "fAngle");
	m_uiAxisLoc = glGetUniformLocation(m_uiProgram, "iAxis");
...
void CQuadEX1::SetAngleAndAxis(float fAngle, int iAxis)
{
